class Reflection():
    ...
    def __call__(self, chatHistory, lastItemsConsidereds=10):
        ...
        higherLevelSummariesPrompt = """Đưa ra lịch sử trò chuyện và câu hỏi mới nhất của người dùng có thể tham khảo ngữ cảnh trong lịch sử trò chuyện, hãy tạo một câu hỏi độc lập bằng tiếng Việt mà không cần lịch sử trò chuyện cũng có thể hiểu được. KHÔNG trả lời câu hỏi, chỉ sửa lại câu hỏi nếu cần và nếu không thì trả lại như cũ. 
        """
